...
const funcStart = content.indexOf('async function fetchMoreNews() {');
const funcEnd = content.indexOf('// Init Page', funcStart);

const cleanFunc = `async function fetchMoreNews() {
...
console.log('✅ Cleaned fetchMoreNews in fixtures.html.');
